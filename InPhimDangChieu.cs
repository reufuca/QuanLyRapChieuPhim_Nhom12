...
namespace QuanLyRapPhim
{
    public partial class InPhimDangChieu : Form
    {
        ...
        private void LoadDataToGridView()
        {
            ...
            DataTable tblPhimDC = new DataTable();
            adapter.Fill(tblPhimDC);
        ...
        private void btnInDTR_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:H2"].Value = "DANH SÁCH PHIM ĐANG CHIẾU";

            tblPhimDC = DAO.GetDataToTable(sql);
            exRange.Range["A6:G6"].Font.Bold = true;
            exRange.Range["A6:G6"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["C6:G6"].ColumnWidth = 15;
            exRange.Range["A6:A6"].Value = "STT";
            exRange.Range["B6:B6"].Value = "Mã phim";
            exRange.Range["C6:C6"].Value = "Tên phim";
            exRange.Range["D6:D6"].Value = "Đạo diễn";
            exRange.Range["E6:E6"].Value = "Tên thể loại";
            exRange.Range["F6:F6"].Value = "Ngày khởi chiếu";
            exRange.Range["G6:G6"].Value = "Ngày kết thúc";
