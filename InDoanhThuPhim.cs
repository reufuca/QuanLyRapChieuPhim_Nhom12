...
namespace QuanLyRapPhim
{
    public partial class InDoanhThuPhim : Form
    {
        ...
        private void btnInDTP_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Tập đoàn tweltfthGROUP";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Hệ thống Rạp chiếu toàn quốc";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Hotline: +8441992809";
            ...
            exRange.Range["C2:H2"].Value = "BÁO CÁO DOANH THU PHIM";
            ...
            exRange.Range["B6:C11"].Font.Size = 12;
            exRange.Range["B6:C11"].Font.Name = "Times new roman";
            exRange.Range["B6:B6"].Value = "Mã phim:";
            exRange.Range["C6:E6"].MergeCells = true;
            exRange.Range["C6:E6"].Value = tblPhim.Rows[0][0].ToString();
            exRange.Range["B7:B7"].Value = "Tên phim:";
            exRange.Range["C7:E7"].MergeCells = true;
            exRange.Range["C7:E7"].Value = tblPhim.Rows[0][1].ToString();
            exRange.Range["B8:B8"].Value = "Ngày khởi chiếu:";
            exRange.Range["C8:E8"].MergeCells = true;
            exRange.Range["C8:E8"].Value = tblPhim.Rows[0][2].ToString();
            exRange.Range["B9:B9"].Value = "Ngày kết thúc:";
            exRange.Range["C9:E9"].MergeCells = true;
            exRange.Range["C9:E9"].Value = tblPhim.Rows[0][3].ToString();
            exRange.Range["B11:B11"].Value = "Doanh thu:";
            exRange.Range["C11:E11"].MergeCells = true;
            exRange.Range["C11:E11"].Value = tblPhim.Rows[0][4].ToString();

            sql = "SELECT SUM(SoVeDaBan) from tblLichChieu where MaPhim = N'" + cboPhim.SelectedValue.ToString() + "'";
            sove = DAO.GetDataToTable(sql);
            exRange.Range["B10:B10"].Value = "Số vé đã bán:";
            exRange.Range["C10:E10"].MergeCells = true;
            exRange.Range["C10:E10"].Value = sove.Rows[0][0].ToString();
            exApp.Visible = true;
        }
    }
}
